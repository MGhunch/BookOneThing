...
function buildReminderHTML(p: {
  ...
  const noteLine    = p.reminderNote
    ? `<tr><td><table cellpadding="0" cellspacing="0"><tr><td style="width:20px;height:20px;"></td><td style="padding-left:10px;font-size:13px;color:#888;font-style:italic;">${p.reminderNote}</td></tr></table></td></tr>`
    : "";
...
${orgLine}
<table width="100%" cellpadding="0" cellspacing="0" style="background:#fdf4ee;border-radius:14px;padding:18px 20px;margin-bottom:28px;">
...
<tr><td${p.reminderNote ? ' style="padding:0 0 10px;"' : ""}><table cellpadding="0" cellspacing="0"><tr>
  <td style="width:20px;height:20px;background:${ORANGE};border-radius:50%;text-align:center;vertical-align:middle;"><svg width="9" height="9" viewBox="0 0 10 10" fill="none" stroke="#fff" stroke-width="3"><polyline points="1.5,5 4,7.5 8.5,2.5"/></svg></td>
  <td style="padding-left:10px;font-size:15px;font-weight:700;color:${DARK};">${dateStr}</td>
</tr></table></td></tr>
${noteLine}
</table>
<p style="margin:0 0 24px;font-size:15px;color:#555;line-height:1.7;">It's all ready, unless you're not...</p>
<table width="100%" cellpadding="0" cellspacing="0" style="margin-bottom:16px;">
<tr><td align="center"><a href="${p.cancelUrl}" style="display:inline-block;background:${DARK};color:#fff;text-decoration:none;font-size:15px;font-weight:700;padding:16px 40px;border-radius:14px;letter-spacing:-0.2px;">Cancel my booking</a></td></tr>
</table>
<p style="margin:0 0 24px;font-size:12px;color:#bbb;text-align:center;line-height:1.6;">Please cancel if you don't need it. Someone else can jump in.</p>
<p style="margin:0 0 16px;font-size:12px;color:#bbb;line-height:1.6;">Got questions? <a href="https://bookonething.com/faq" style="color:#888;">Check the FAQs.</a></p>
<p style="margin:0;font-size:13px;font-weight:700;color:${DARK};">All set. Let's book some things.</p>
</td></tr>
